...
const DEFAULT_IMAGES: DomeGalleryImage[] = [
  {
    src: '/products/watch.webp',
    alt: 'Luxury Watch'
  },
  {
    src: '/products/bmw.avif',
    alt: 'BMW Luxury Vehicle'
  },
  {
    src: '/products/necleas.webp',
    alt: 'Diamond Necklace'
  },
  {
    src: '/products/rangerover.avif',
    alt: 'Range Rover SUV'
  },
  {
    src: '/products/bangles.webp',
    alt: 'Fine Jewelry Bangles'
  },
  {
    src: '/products/mersadies.avif',
  ...
  {
    src: '/products/himalayan.jpg',
    alt: 'Royal Enfield Himalayan'
  },
  {
    src: '/products/rings.webp',
    alt: 'Diamond Rings'
  },
  {
    src: '/products/car3.jpg',
    alt: 'Sports Performance Car'
  },
  {
    src: '/products/bags.jpg',
    alt: 'Designer Travel Bags'
  },
  {
    src: '/products/royalenfield.webp',
  ...
  {
    src: '/products/sofas.webp',
    alt: 'Premium Designer Sofa'
  },
  {
    src: '/products/paintings.webp',
    alt: 'Modern Fine Art'
  },
  {
    src: '/products/shan.webp',
...
function buildItems(pool: (string | DomeGalleryImage)[], seg: number) {
...
export default function DomeGallery({
  ...
  // Continuous Ambient Slow Rotation Loop
  ...
  useEffect(() => {
    ...
    const animateAuto = (ts: number) => {
      if (lastAutoTimeRef.current === null) lastAutoTimeRef.current = ts;
      const dt = Math.min(0.05, (ts - lastAutoTimeRef.current) / 1000);
      lastAutoTimeRef.current = ts;

      if (!draggingRef.current && !inertiaRAF.current && !focusedElRef.current && !openingRef.current) {
        const nextY = wrapAngleSigned(rotationRef.current.y + autoRotateSpeed * 15 * dt);
        rotationRef.current.y = nextY;
        applyTransform(rotationRef.current.x, nextY);
      }

      autoRotateRAF.current = requestAnimationFrame(animateAuto);
    };
